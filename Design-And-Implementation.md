...
- [ ] Allow for opt in - user A will not automatically get points from users they did not opt in to;
- [ ] Allow for user blocking, where points get deducted from the assignee but do not get tacked on to the target;
